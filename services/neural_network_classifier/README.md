...
│   │   ├── models
│   │   │   ├── __init__.py
│   │   │   ├── neural_network_classifier.py                // estimator, result and validator models
│   │   │   └── neural_network_classifier_estimator.py      // machine learning model class
│   │   ├── result.py
│   │   └── validator.py
...
Source: `src/ml_models/models/neural_network_classifier_estimator.py`  
