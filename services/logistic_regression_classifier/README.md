...
│   │   ├── models
│   │   │   ├── __init__.py
│   │   │   ├── logistic_regression_tree_classifier.py                // estimator, result and validator models
│   │   │   └── logistic_regression_tree_classifier_estimator.py      // machine learning model class
│   │   ├── result.py
│   │   └── validator.py
...
Source: `src/ml_models/models/logistic_regression_tree_classifier_estimator.py`  
