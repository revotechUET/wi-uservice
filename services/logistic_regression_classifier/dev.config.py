...
daemon = False
raw_env = [
    "DB_HOST="+os.environ.get("DB_HOST", "172.19.0.15"),
...
pidfile = "/tmp/logistic_regression_tree_classifier.pid"
umask = 0
user = None
group = None
tmp_upload_dir = None
...
errorlog = '-'
loglevel = 'debug'
accesslog = '/tmp/logistic_regression_tree_classifier.access.log'
