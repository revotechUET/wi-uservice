...
│   │   ├── models
│   │   │   ├── __init__.py
│   │   │   ├── linear_regression.py                // estimator, result and validator models
│   │   │   └── linear_regression_estimator.py      // machine learning model class
│   │   ├── result.py
│   │   └── validator.py
...
Source: `src/ml_models/models/linear_regression_estimator.py`  
