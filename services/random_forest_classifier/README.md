...
│   │   ├── models
│   │   │   ├── __init__.py
│   │   │   ├── random_forest_classifier.py                // estimator, result and validator models
│   │   │   └── random_forest_classifier_estimator.py      // machine learning model class
│   │   ├── result.py
│   │   └── validator.py
...
Source: `src/ml_models/models/random_forest_classifier_estimator.py`  
