...
│   │   ├── models
│   │   │   ├── __init__.py
│   │   │   ├── k_nearest_neighbors_classifier.py                // estimator, result and validator models
│   │   │   └── k_nearest_neighbors_classifier_estimator.py      // machine learning model class
│   │   ├── result.py
│   │   └── validator.py
...
Source: `src/ml_models/models/k_nearest_neighbors_classifier_estimator.py`  
